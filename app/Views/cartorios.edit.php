        ...
        <div class="col-md-12">
            ...
            <form method="post" action="/editar">
                ...
                <div class="form-group">
                    ...
                    <input id="documento" name="documento" type="text" class="form-control" required="required" value="<?php echo $cartorio['documento']; ?>">
                </div>
                <div class="form-group">
                    <label for="cep">CEP</label>
                    <input id="cep" name="cep" type="text" class="form-control" required="required" value="<?php echo $cartorio['cep']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="telefone" name="telefone" type="text" class="form-control" value="<?php echo $cartorio['telefone']; ?>">
                </div>
                <div class="form-group">
